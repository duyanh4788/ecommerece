            ...
            <div class="container">
                <div class="row">
                    <div class="column_1">
                        <img width="80px" height="80px" alt="image"
                            src="https://dv19cu1ukmppw.cloudfront.net/ecommerce/bannernode.png" />
                    </div>
                    <div class="column_2">
                ...
                <div style="background-color: #F7F7F7;">
                    ...
                    <div style="padding: 20px;">
                          <div class="row">
                            <div class="column_5">
                                <img alt="image" src="https://dv19cu1ukmppw.cloudfront.net/ecommerce/bannernode.png" width="40px"
                                    height="40px" />
                                <span
