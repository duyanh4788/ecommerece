...
insert into ECOMMERCE.paypal_billing_plans(planId,tier,frequency,amount, numberProduct, numberIndex, isTrial ,created_at,updated_at)
values
('P-6BD52515CH8069818MSNOZFQ','starter','monthly',3, 2, 5, true, CURRENT_DATE(), CURRENT_DATE()),
('P-71R83116Y80649614MSNOZVA','starter_no_trial', 'monthly', 3, 2, 5, false, CURRENT_DATE(),CURRENT_DATE()),
('P-4HR71448Y8776983LMSNO2CY','premium','monthly',5, 3, 10, true, CURRENT_DATE(),CURRENT_DATE()),
('P-4H466789MB5502423MSNO2JI','premium_no_trial', 'monthly', 5, 3, 10, false, CURRENT_DATE(),CURRENT_DATE()),
('P-5A2117958A9404827MSNO2XQ','pro','monthly',7, 4, 20, true, CURRENT_DATE(),CURRENT_DATE()),
('P-6X1260512V9779744MSNO25I','pro_no_trial', 'monthly', 7, 4, 20, false, CURRENT_DATE(),CURRENT_DATE());