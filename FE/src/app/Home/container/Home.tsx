...
export const Home = () => {
  const data = [
    ...
    'https://dv19cu1ukmppw.cloudfront.net/img/funiture.png',
    'https://dv19cu1ukmppw.cloudfront.net/img/free.png',
    'https://dv19cu1ukmppw.cloudfront.net/img/electronic.png',
    'https://dv19cu1ukmppw.cloudfront.net/img/elacticsearch.png',
    'https://dv19cu1ukmppw.cloudfront.net/img/ecommerce.png',
    'https://dv19cu1ukmppw.cloudfront.net/img/cosmetics.png',
    'https://dv19cu1ukmppw.cloudfront.net/img/clothes.png',
